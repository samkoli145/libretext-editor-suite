...
- **Tool Registry [PLAY-SHELL-TOOLS-001]:** حصر 57 أداة بتنظيم 4 مواضع ضد اكتظاظ منطقة العمل: شريط أساسي (≤9 أدوات عمل، أدوات العرض دائمة)، فائض ⋮، سياق زر أيمن، لوحة أوامر بحث. **6 خانات محجوزة للمستقبل** (AI/تعاون/ماكرو/رسوم/PDF/إصدارات) تظهر شبحياً وتشير لمحركات جاهزة.
- **Visual App [PLAY-APP-001]:** الواجهة الحية الكاملة — تبويبات ملونة، شريط سياقي، قوائم منسدلة، لوحة أوامر بحث فوري، صفحة إعدادات (14 ثيمة + 6 خلفيات)، مشاهد مربوطة بالمحركات الحقيقية. CSS مدمج RTL فاتح.
