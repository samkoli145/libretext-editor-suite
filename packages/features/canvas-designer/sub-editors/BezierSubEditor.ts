  ...
  attach(targetId: string, elementData: any, surface: CanvasSurface): void {
    ...
    if (!this.elementData.nodes || !Array.isArray(this.elementData.nodes)) {
      this.elementData.nodes = [
        {
          p: { x: this.elementData.x ?? 50, y: this.elementData.y ?? 50 },
          out: { x: (this.elementData.x ?? 50) + 40, y: this.elementData.y ?? 50 },
        },
        {
          p: { x: (this.elementData.x ?? 50) + 150, y: (this.elementData.y ?? 50) + 100 },
          in: { x: (this.elementData.x ?? 50) + 110, y: (this.elementData.y ?? 50) + 100 },
        },
      ];
    }
  }
