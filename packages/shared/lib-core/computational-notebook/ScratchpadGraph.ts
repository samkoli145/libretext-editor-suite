...
export function buildGraphFromExpressions(vars: Map<string, string>): DependencyGraph {
...
export function getAffectedVariables(graph: DependencyGraph, changedVar: string): string[] {
...
export function verifyTopologicalOrder(order: string[], graph: DependencyGraph): boolean {
