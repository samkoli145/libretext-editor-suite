...
export const STANDARD_DYNAMIC_FIELDS: DynamicFieldDefinition[] = [
  { token: '{{date}}', label: 'التاريخ الحالي', category: 'datetime', description: 'تاريخ اليوم بالتنسيق المحلي', example: '2026-08-18' },
  { token: '{{time}}', label: 'الوقت الحالي', category: 'datetime', description: 'الوقت الحالي بالدقائق والثواني', example: '14:30' },
  { token: '{{page}}', label: 'رقم الصفحة', category: 'pagination', description: 'رقم الصفحة الحالية', example: '1' },
  { token: '{{pages}}', label: 'إجمالي الصفحات', category: 'pagination', description: 'عدد صفحات المستند الإجمالي', example: '5' },
  { token: '{{title}}', label: 'عنوان المستند', category: 'metadata', description: 'العنوان التعريفي للمستند', example: 'تقرير المشروع' },
  { token: '{{author}}', label: 'اسم المؤلف', category: 'metadata', description: 'اسم المستخدم أو منشئ المستند', example: 'أحمد' },
  { token: '{{wordcount}}', label: 'عدد الكلمات', category: 'metadata', description: 'إجمالي الكلمات المكتوبة في المستند', example: '1250' },
]
...
export function resolveDynamicFields(text: string, context: FieldContext = {}): string {
  ...
  const formattedDate = now.toLocaleDateString('ar-SA', { year: 'numeric', month: 'long', day: 'numeric' })
