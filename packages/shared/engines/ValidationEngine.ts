 ...
 * ═══════════════════════════════════════════════════════════════════════════
 * 🎯 المهمة: محرك فحص وتعقيم الكود والمستندات - Validation Issues و Sanitization
 * 🏛️ الدور: محرك مشترك - فحص سلامة المدخلات والمخرجات
 * 📥 المستهلك: InteractiveWysiwygCodeStudio, LiveInterpreterEngine
 * ═══════════════════════════════════════════════════════════════════════════
 ...
 * ═══════════════════════════════════════════════════════════════════════════
 */
// src/shared/engines/ValidationEngine.ts
/**
 * محرك فحص وتعقيم الكود والمستندات — 100% بدون أي مكتبات خارجية
 */
...
export class ValidationEngine {
  ...
  public sanitize(html: string): string {
    if (!html) return '';
    // Strip dangerous script tags and dangerous handlers
    return html
