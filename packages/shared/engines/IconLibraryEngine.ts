...
export const ICON_LIBRARY: SVGIcon[] = [
  // واجهة
  I('home', 'الرئيسية', 'home', 'واجهة', ['بيت', 'منزل', 'house'],
    '<path d="M3 10.5 12 3l9 7.5"/><path d="M5 10v11h5v-6h4v6h5V10"/>'),
  I('search', 'بحث', 'search', 'واجهة', ['تحري', 'find', 'lookup'],
    '<circle cx="11" cy="11" r="7"/><line x1="21" y1="21" x2="16.5" y2="16.5"/>'),
  I('user', 'مستخدم', 'user', 'واجهة', ['شخص', 'حساب', 'profile'],
    '<circle cx="12" cy="8" r="4"/><path d="M4 21c0-4 4-6 8-6s8 2 8 6"/>'),
  I('settings', 'إعدادات', 'settings', 'واجهة', ['ضبط', 'خيارات', 'gear'],
  ...
  I('menu', 'قائمة', 'menu', 'واجهة', ['خطوط', 'burger'],
    '<line x1="4" y1="6" x2="20" y2="6"/><line x1="4" y1="12" x2="20" y2="12"/><line x1="4" y1="18" x2="20" y2="18"/>'),
  I('check', 'موافق', 'check', 'واجهة', ['تم', 'صح', 'ok'],
    '<polyline points="4 12 10 18 20 6"/>'),
  I('close', 'إغلاق', 'close', 'واجهة', ['إكس', 'حذف', 'x'],
    '<line x1="5" y1="5" x2="19" y2="19"/><line x1="19" y1="5" x2="5" y2="19"/>'),
  I('plus', 'إضافة', 'plus', 'واجهة', ['جديد', 'add'],
    '<line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/>'),
  I('eye', 'عرض', 'eye', 'واجهة', ['رؤية', 'مشاهدة', 'view'],
    '<path d="M2 12s4-7 10-7 10 7 10 7-4 7-10 7S2 12 2 12z"/><circle cx="12" cy="12" r="3"/>'),
  I('lock', 'قفل', 'lock', 'واجهة', ['أمان', 'حماية', 'security'],
    '<rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 0 1 8 0v4"/>'),
  I('bell', 'تنبيه', 'bell', 'واجهة', ['جرس', 'إشعار', 'notification'],
    '<path d="M6 9a6 6 0 0 1 12 0c0 5 2 6 2 6H4s2-1 2-6"/><path d="M10 20a2 2 0 0 0 4 0"/>'),
  I('edit', 'تحرير', 'edit', 'واجهة', ['قلم', 'تعديل', 'pencil'],
    '<path d="M4 20l4-1L20 7l-3-3L5 16z"/>'),
  I('copy', 'نسخ', 'copy', 'واجهة', ['تكرار', 'duplicate'],
    '<rect x="9" y="9" width="12" height="12" rx="2"/><path d="M5 15V5a2 2 0 0 1 2-2h10"/>'),
  I('link', 'رابط', 'link', 'واجهة', ['وصلة', 'url', 'chain'],
    '<path d="M10 14a5 5 0 0 0 7 0l3-3a5 5 0 0 0-7-7l-1.5 1.5"/><path d="M14 10a5 5 0 0 0-7 0l-3 3a5 5 0 0 0 7 7l1.5-1.5"/>'),

  // شروحات وتوضيحات
  I('message-square', 'مربع شرح', 'callout', 'شروحات', ['توضيح', 'تعليق', 'فقاعة'],
    '<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>'),
  I('help-circle', 'مساعدة وملاحظة', 'help', 'شروحات', ['سؤال', 'استفسار', 'شرح'],
    '<circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/>'),
  I('info', 'معلومات وتنبيه', 'info', 'شروحات', ['تنبيه', 'إرشاد', 'guide'],
    '<circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/>'),
  I('pin', 'دبوس الإشارة', 'pin', 'شروحات', ['تحديد', 'نقطة', 'spotlight'],
    '<path d="M12 2v8"/><path d="m4.93 10.93 1.41 1.41"/><path d="M2 18h20"/><path d="M12 18v4"/>'),

  // أسهم
  I('arrow-right', 'سهم يمين', 'arrow-right', 'أسهم', ['اتجاه', 'forward'],
    '<line x1="4" y1="12" x2="20" y2="12"/><polyline points="14 6 20 12 14 18"/>'),
  I('arrow-left', 'سهم يسار', 'arrow-left', 'أسهم', ['رجوع', 'back'],
    '<line x1="20" y1="12" x2="4" y2="12"/><polyline points="10 6 4 12 10 18"/>'),
  I('arrow-up', 'سهم أعلى', 'arrow-up', 'أسهم', ['فوق', 'up'],
    '<line x1="12" y1="20" x2="12" y2="4"/><polyline points="6 10 12 4 18 10"/>'),
  I('arrow-down', 'سهم أسفل', 'arrow-down', 'أسهم', ['تحت', 'down'],
    '<line x1="12" y1="4" x2="12" y2="20"/><polyline points="6 14 12 20 18 14"/>'),
  I('download', 'تنزيل', 'download', 'أسهم', ['تحميل', 'حفظ', 'save'],
    '<path d="M12 3v12"/><polyline points="6 9 12 15 18 9"/><line x1="4" y1="21" x2="20" y2="21"/>'),
  I('upload', 'رفع', 'upload', 'أسهم', ['تحميل لأعلى', 'publish'],
    '<path d="M12 21V9"/><polyline points="6 15 12 9 18 15"/><line x1="4" y1="3" x2="20" y2="3"/>'),

  // ملفات
  I('folder', 'مجلد', 'folder', 'ملفات', ['directory', 'حافظة'],
    '<path d="M3 6a2 2 0 0 1 2-2h5l2 3h7a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/>'),
  I('file', 'ملف', 'file', 'ملفات', ['مستند', 'document'],
    '<path d="M6 2h8l5 5v15H6z"/><path d="M14 2v5h5"/>'),
  I('trash', 'سلة المهملات', 'trash', 'ملفات', ['حذف', 'delete', 'bin'],
  ...
  I('star', 'نجمة', 'star', 'طبيعة', ['مفضلة', 'تقييم', 'favorite'],
    '<path d="M12 3l2.7 5.6 6.1.9-4.4 4.3 1 6.1-5.4-2.9-5.4 2.9 1-6.1L3.2 9.5l6.1-.9z"/>'),
  I('heart', 'قلب', 'heart', 'طبيعة', ['حب', 'إعجاب', 'like'],
  ...
  // تجارة
  I('cart', 'سلة شراء', 'cart', 'تجارة', ['متجر', 'shop', 'buy'],
    '<circle cx="9" cy="20" r="1.5"/><circle cx="17" cy="20" r="1.5"/><path d="M3 4h3l2.5 11h9L20 8H7"/>'),
  I('chart', 'رسم بياني', 'chart', 'تجارة', ['إحصائيات', 'stats'],
  ...
  I('rocket', 'صاروخ', 'rocket', 'تجارة', ['إطلاق', 'نشر', 'launch'],
...
export class IconLibraryEngine {
  ...
  public toDataUrl(
    icon: SVGIcon,
    opts?: Parameters<IconLibraryEngine['toSvg']>[1]
  ): string {
    return `data:image/svg+xml;utf8,${encodeURIComponent(this.toSvg(icon, opts))}`;
  }

  public toHtml(icon: SVGIcon, opts?: { size?: number; color?: string; strokeWidth?: number }): string {
